...
public class PotionSourPucker extends Potion {
    private static final ResourceLocation ICON = new ResourceLocation(
        ExtraDelightLegacy.MODID,
        "textures/mob_effect/sour_pucker.png"
    );

    public PotionSourPucker() {
        super(false, 0xF8FC14);
        setPotionName("effect.extradelightlegacy.sour_pucker");
    }
